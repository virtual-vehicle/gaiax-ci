...
function transformCdkMetric(metricArray) {
    ...
    for (let metricObject of metricArray) {
        metrics.push({
            ...
            attributes: {
                module: metricObject["@_module"],
                interpreter: metricObject["@_interpreter"],
                interpreterVersion: metricObject["@_interpreterVersion"],
...
function transformCdkSimpleProcessing(simpleProcessing) {
    return {
        attributes: {
            module: simpleProcessing["@_module"],
            interpreter: simpleProcessing["@_interpreter"],
            interpreterVersion: simpleProcessing["@_interpreterVersion"],
...
function transformCdkComplexProcessing(complexProcessing) {
    return {
        attributes: {
            interpreter: complexProcessing['@_interpreter'],
